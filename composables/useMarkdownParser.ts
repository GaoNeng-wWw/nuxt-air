...
import MaterialThemeDark from 'shiki/themes/material-theme-darker.mjs'
import MaterialThemeLight from 'shiki/themes/material-theme-ocean.mjs';

export const useMarkdownParser = async () => {
  let parser: Awaited<ReturnType<typeof createMarkdownParser>>
  const langs = (await import('shiki/langs.mjs')).bundledLanguagesBase
