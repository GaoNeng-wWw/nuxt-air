...
<template>
  <drawer-root v-model:open="_show">
    <drawer-portal>
      <drawer-overlay class="fixed inset-0 bg-black/40 size-full" />
      <transition appear @leave="onLeave">
        <drawer-content class="h-fit fixed bottom-0 left-0 right-0 outline-none bg-default-100 rounded-t-xl">
          <div class="p-4">
